              ...
              <h3 className="text-sm font-luxury font-medium text-gray-400 uppercase tracking-wider">
               ...
               <div className="space-y-3">
                 <div className="flex items-center space-x-3">
                   ...
                   <span className="text-gray-700 text-sm font-luxury leading-relaxed whitespace-nowrap">
                     {contactInfo.address}
                   </span>
                 </div>
                 <div className="flex items-center space-x-3">
                   ...
                   <a
                     ...
                     className="text-gray-700 hover:text-burgundy transition-colors text-sm font-luxury whitespace-nowrap"
